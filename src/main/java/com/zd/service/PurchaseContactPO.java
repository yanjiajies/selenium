...
public class PurchaseContactPO {
    ...
    private ServiceFillPage pfp;
    private ExaminationPage ep;
    ...
    public PurchaseContactPO(WebDriver driver) {
        ...
        pfp = new ServiceFillPage(driver);
        ep=new ExaminationPage(driver);
    ...
    public void itemSelection(String typeName, String contact_number, String estimated_amount, String task_name, String demand_time,
                              ...
                              String t_number,String t_unit,String t_remark,String demand_des) {
        pcp.clickLockOrUnLockUser(typeName);
